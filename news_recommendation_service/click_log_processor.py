...
NUM_OF_CLASSES = config['news_recommendation_service']['click_log_processor']['NUM_OF_CLASSES']
INITIAL_P = 1.0 / NUM_OF_CLASSES
ALPHA = config['news_recommendation_service']['click_log_processor']['ALPHA']

SLEEP_TIME_IN_SECONDS = config['news_recommendation_service']['click_log_processor']['SLEEP_TIME_IN_SECONDS']

LOG_CLICKS_TASK_QUEUE_URL = config['news_recommendation_service']['click_log_processor']['LOG_CLICKS_TASK_QUEUE_URL']
LOG_CLICKS_TASK_QUEUE_NAME = config['news_recommendation_service']['click_log_processor']['LOG_CLICKS_TASK_QUEUE_NAME']

PREFERENCE_MODEL_TABLE_NAME = config['news_recommendation_service']['click_log_processor']['PREFERENCE_MODEL_TABLE_NAME']
NEWS_TABLE_NAME = config['news_recommendation_service']['click_log_processor']['NEWS_TABLE_NAME']
